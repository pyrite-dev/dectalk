 ...
 */
...
#ifdef FULL_LANGUAGE_SUPPORT
				KS.ascky = (unsigned char*)usa_ascky;
				KS.ascky_size = sizeof(usa_ascky);
				KS.reverse_ascky = (short*)usa_ascky_rev;
				KS.arpabet = (unsigned char*)usa_arpa;
				KS.arpa_size = sizeof(usa_arpa);
				KS.arpa_case = FALSE;
				KS.typing_table = (volatile unsigned char **) usa_type;
				KS.error_table = (volatile unsigned char **) usa_error;
#endif
#ifdef FULL_LTS   // Changed to allow say letter as per Ed Bruckert
				KS.typing_table = (volatile unsigned char **) usa_type;
				KS.reverse_ascky = (short*)usa_ascky_rev;
	...
	nlt.lang_ascky = (unsigned char*)usa_ascky;
	nlt.lang_ascky_size = sizeof(usa_ascky);
	nlt.lang_reverse_ascky = (short*)usa_ascky_rev;
	nlt.lang_arpabet = (unsigned char*)usa_arpa;
	nlt.lang_arpa_size = sizeof(usa_arpa);
	nlt.lang_arpa_case = FALSE;
	nlt.lang_typing =	(unsigned char **) usa_type;
	nlt.lang_error = (unsigned char **) usa_error;
#endif
/*
 *  thread on chain ...
 */
