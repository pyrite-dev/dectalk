...
// extern functions
extern void stress_fr (PHONE *fpp, PHONE *lpp, short pstype);
extern void stress_ge (PHONE *fpp, PHONE *lpp, short pstype);
extern void stress_it (PHONE *fpp, PHONE *lpp, short pstype);
extern void stress_ja (PHONE *fpp, PHONE *lpp, short pstype);
extern void stress_sp (PHONE *fpp, PHONE *lpp, short pstype);
extern void stress_sl (PHONE *fpp, PHONE *lpp, short pstype);

// function prototypes
int acna_prefixscan(PHONE   *fpp, PHONE   *lpp, short lang_tag);
 ...
 */
int acna_prefixscan(fpp, lpp, lang_tag)
PHONE	*fpp;
PHONE	*lpp;
short lang_tag;
{
